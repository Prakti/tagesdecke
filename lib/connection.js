...
Connection.prototype.make_request = function make_request(method, path, opts) {
   ...
   * @property {Object} headers - Object containing key/value pairs of custom
   *                              HTTP Headers
   * @property {Object} parms - Object containing key/value pairs of
   *                            parameters to be appended to the URL
   * @property {Object} body - Object or Array to be JSON encoded and put into
   *                           the request body
   */
  if (opts) {
    if (opts.headers) {
